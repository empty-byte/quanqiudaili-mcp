...
paths:
  /externalapi/device/batchUpdateSubAccountUsernamePassword:
    post:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5275065/apis/api-222612150-run
components:
  schemas: {}
  securitySchemes: {}
servers:
