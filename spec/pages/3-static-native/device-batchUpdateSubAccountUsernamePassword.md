...
paths:
  /externalapi/device/batchUpdateSubAccountUsernamePassword:
    put:
      summary: 自定义静态住宅（原生）IP子账号用户名和密码
      deprecated: false
      description: ''
      tags:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5275065/apis/api-245746648-run
components:
  schemas: {}
  securitySchemes: {}
servers:
